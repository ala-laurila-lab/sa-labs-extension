classdef AaltoPatchRigOneAmp < symphonyui.core.descriptions.RigDescription
    
    methods
        
        function obj = AaltoPatchRigOneAmp()
            ...
            lightCrafter = sa_labs.devices.LightCrafterDevice('micronsPerPixel',  1.86);
